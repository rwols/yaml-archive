...
// this module is derived from simpleyaml.cpp - an example shipped as part of
...
template <class CharType> class basic_yaml_grammar
{
  ...
  private:
    ...
    bool parse(unsigned int depth, IStream& is, const rule_t& rule_,
  ...
  public:
    ...
    bool parse_end_tag(unsigned int depth, IStream& is) const;
    bool parse_string(unsigned int depth, IStream& is, StringType& s) /*const*/;
