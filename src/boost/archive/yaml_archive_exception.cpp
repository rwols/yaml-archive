...
BOOST_ARCHIVE_DECL
yaml_archive_exception::yaml_archive_exception(yaml_archive_exception const & oth) :
 	archive_exception(oth)
	{
	}
	
BOOST_ARCHIVE_DECL yaml_archive_exception::~yaml_archive_exception() BOOST_NOEXCEPT_OR_NOTHROW {}
