...
template <class T> const boost::serialization::extended_type_info& eti() {
...
int test_main(int /* argc */, char* /* argv */ []) {
    ...
    BOOST_CHECK(vpmd == boost::serialization::void_downcast(
                            eti<MostDerived>(), eti<Derived>(), vpd));
    ...
    BOOST_CHECK(vpmd == boost::serialization::void_downcast(
                            eti<MostDerived>(), eti<Base1>(), vpb1));
    ...
    BOOST_CHECK(vpmd == boost::serialization::void_downcast(
                            eti<MostDerived>(), eti<Base2>(), vpb2));
