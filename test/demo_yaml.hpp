#ifndef BOOST_SERIALIZATION_EXAMPLE_DEMO_YAML_HPP
#define BOOST_SERIALIZATION_EXAMPLE_DEMO_YAML_HPP
...
class gps_position
{
    ...
    void serialize(Archive& ar, const unsigned int /* file_version */)
    {
        ar& BOOST_SERIALIZATION_NVP(degrees) &
            BOOST_SERIALIZATION_NVP(minutes) & BOOST_SERIALIZATION_NVP(seconds);
    }
...
class bus_route
{
    ...
    void serialize(Archive& ar, const unsigned int version)
    {
        // in this program, these classes are never serialized directly but
        // rather
        // through a pointer to the base class bus_stop. So we need a way to be
        // sure that the archive contains information about these derived
        // classes.
...
#endif // BOOST_SERIALIZATION_EXAMPLE_DEMO_YAML_HPP
