...
template <class T> void save(const char* testfile, const T& spa)
{
...
template <class T> void load(const char* testfile, T& spa)
{
...
// trivial test
template <class T> void save_and_load(const T& spa)
{
    const char* testfile = "test_shared_ptr_132_1.yml";
...
template <class T> void load2(const char* testfile, T& first, T& second)
{
    test_istream  is(testfile, TEST_STREAM_FLAGS);
    test_iarchive ia(is, TEST_ARCHIVE_FLAGS);
...
template <class T> void save_and_load2(T& first, T& second)
{
    const char* testfile = "test_shared_ptr_132_2.yml";
    BOOST_REQUIRE(NULL != testfile);
