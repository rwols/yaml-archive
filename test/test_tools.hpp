...
#define BOOST_CHECK_MESSAGE(P, M)                                              \
    ((P) ? (void)0 : ::boost::detail::error_impl((M), __FILE__, __LINE__,      \
...
#define BOOST_WARN_MESSAGE(P, M)                                               \
    ((P) ? (void)0 : ::boost::detail::msg_impl((M), __FILE__, __LINE__,        \
                                               BOOST_CURRENT_FUNCTION))
...
#error                                                                         \
    "Please point BOOST_ARCHIVE_TEST to the config file describing the archive."
#endif
