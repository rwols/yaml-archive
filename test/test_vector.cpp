...
template <class T> int test_vector_detail(const std::vector<T>& avector)
{
    std::string testfile = "test_vector_" + std::to_string(counter) + ".yml";
    ++counter;
...
template <class T> int test_default_constructible()
{
    // test array of objects
