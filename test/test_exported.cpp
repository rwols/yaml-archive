...
class polymorphic_derived1 : public polymorphic_base {
    ...
    virtual const char* get_key() const { return "polymorphic_derived1"; }
  public:
...
polymorphic_derived2::serialize(test_oarchive& ar, const unsigned int version);
template BOOST_SYMBOL_EXPORT void
polymorphic_derived2::serialize(test_iarchive& ar, const unsigned int version);
...
{
    const char* testfile = "exported.yml";
